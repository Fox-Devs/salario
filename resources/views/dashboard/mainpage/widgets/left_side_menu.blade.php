...
<li class=" navigation-header"><span>Employee Management</span>
      ...
      <li class="nav-item"><a href="#"><i data-feather="user" class="foo"></i><span class="menu-title" data-i18n="Employee Management">Employee Management</span></a>
        <ul class="menu-content">
          ...
          <li class="{{ Route::currentRouteNamed('employee_list','employee_view','employee_edit') ? 'active' : '' }}"><a href="{{ route('employee_list') }}"><i data-feather="users" class="foo"></i><span class="menu-item" data-i18n="Employee List">Employee List</span></a>
          </li>
        </ul>
      </li>
      ...
      <li class=" nav-item"><a href="#"><i data-feather="credit-card" class="foo"></i><span class="menu-title" data-i18n="Payroll">Payroll</span></a>
        <ul class="menu-content">
          <li class="{{ Route::currentRouteNamed('salary_benifits','salary_benifits_edit') ? 'active' : '' }}"><a href="{{ route('salary_benifits') }}"><i data-feather="gift" class="foo"></i><span class="menu-item" data-i18n="Salary Type">Salary Benifits</span></a>
          </li>
