...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="//at.alicdn.com/t/font_o5hd5vvqpoqiwwmi.css"> <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/app-assets/vendors/css/vendors.min.css') }}"> <!-- END: Vendor CSS-->
    <!-- BEGIN: Theme CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/app-assets/css/themes/semi-dark-layout.min.css') }}"> <!-- BEGIN: Page CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/app-assets/css/pages/authentication.css') }}"> <!-- END: Page CSS-->
    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('dashboard/assets/css/style.css') }}"> <!-- END: Custom CSS-->
...
<body class="vertical-layout vertical-menu-modern 1-column  navbar-floating footer-static bg-full-screen-image  blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center">
                                  <img src="{{ asset('dashboard/app-assets/images/pages/forgot-password.png') }}" alt="branding logo"> </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                              ...
                                              @endif
                                                ...
                                                <form id="recover-form" method="POST" action="{{ route('password.email') }}">
                                                  @csrf
                                                ...
                                                <div class="float-md-left d-block mb-1"> <a href="{{ route('login') }}" class="btn btn-outline-primary btn-block px-75">Back to Login</a> </div>
                                                <div class="float-md-right d-block mb-1">
                                                  <a href="{{ route('password.email') }}" class="btn btn-primary btn-block px-75" onclick="event.preventDefault();
                                                                document.getElementById('recover-form').submit();">Recover Password</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <!-- BEGIN: Vendor JS-->
    <script src="{{ asset('dashboard/app-assets/vendors/js/vendors.min.js') }}"></script> <!-- BEGIN Vendor JS-->
    ...
    <script src="{{ asset('dashboard/app-assets/js/scripts/components.min.js') }}"></script> <!-- END: Theme JS-->
    <!-- BEGIN: Page JS-->
    <script src="https://res.cloudinary.com/dvd2tat8q/raw/upload/v1571473785/js/sweetalert2.all_g3qaus.js"></script>
    <script type="text/javascript">
        < blade include('sweetalert::alert') / >
    </script> <!-- END: Page JS-->
</body> <!-- END: Body-->
